		...
		<div>
			...
			<div class="content-detail">
				...
				<div class="page-content">
					<div class="content-desc u-pull-right"><span class="icon-glyph glyph-emark-dot color-warning"></span><spring:message code='notice.field.required'/></div>
					<div style="height: 10px;">&nbsp;</div>
					<div class="tabs">
						<ul>
							<li><a href="#project_tab"><spring:message code='project.information'/></a></li>
						</ul>
						<div id="project_tab">
							...
							<table class="input-table scope-row">
								...
								<tr>
									...
									<spring:message var='unused' code='unused'/>
										<form:radiobutton path="use_yn" value="Y" label="${use}" />
										<form:radiobutton path="use_yn" value="N" label="${unused}" />
									</td>
								</tr>
								<tr>
									<th class="col-label" scope="row">
							...
							<div class="button-group">
								<div id="insertProjectLink" class="center-buttons">
									...
									<a href="/project/list-project.do" class="button"><spring:message code='list'/></a>
								</div>
							</div>
							</form:form>
						</div>
