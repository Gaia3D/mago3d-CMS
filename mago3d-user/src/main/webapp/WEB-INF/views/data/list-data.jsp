...
<head>
	...
	<title>데이터 목록 | mago3D User</title>
				...
				<div class="filters">
	   				...
	   				<div class="input-group row">
						...
						<div class="input-set">
							...
							<select id="status" name="status" class="select" style="height: 30px;">
