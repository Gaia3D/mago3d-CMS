...
<nav class="nav">
	...
	<section>
		...
		<div class="docs-main">
			...
			<div class="sub_title">3 Results and Conclusions</div>
			<div class="sub_main">
				<div class="sub_title">3.1 Results</div>
				<p>Mago3D.js and F4D format has been tested at demonstration site(http://www.mago3d.com/mago3d/) first and then applied to the real site.</p>
				<a href="https://easychair.org/conferences/?conf=bimgsuis2017"><mark>https://easychair.org/conferences/?conf=bimgsuis2017</mark></a>
				<p>Deadline for submissions is 20 April 2017.</p>
			</div>
			<div class="sub_title">4 Format of The Extended Abstract</div>
			<div class="sub_main">
				<ul>
					<li>No spaces should be placed between paragraphs.</li>
				</ul>
				<div class="sub_title">Fonts</div>
				<div class="sub_title">Tables and Figures</div>
				<p>see the following examples for preparing and captioning figures and tables.</p>
				<b>Table 1 Caption of example table</b>
				<table>
					<tr>
						<th rowspan="2">Standard Error</th>
						<th colspan="4">20 Story</th>
						<th colspan="4">30 Story</th>
					</tr>
					<tr>
						<td>Uniform</td>
						<td>ELF</td>
				...
				<img src="/images/${lang}/homepage/spec10.png">
				<div class="description">Figure 1 Part of a 3D building model showing carpark spaces</div>
			</div>
			<div class="sub_title">5 References and Citations</div>
			<div class="sub_main">
				<p>Citations in text and bibliography list must be done according to A.P.A. style 6th Edition.
					For more information, please visit the below links:
				</p>
				<a href="http://www.apastyle.org/index.aspx" style="color: blue;">http://www.apastyle.org/index.aspx</a>
				<a href="http://library.canterbury.ac.nz/files/APA_6th_guide_education.pdf" style="color: blue;">http://library.canterbury.ac.nz/files/APA_6th_guide_education.pdf</a>		
			</div>
			<b>Examples of headings are provided below.</b>
			<div class="sub_title">6 Three Dimensional Spatial Models (Heading 1 Example, Capitalize Each Word, Font: Times New Roman 14 Bold)</div>
			<div class="sub_main">
				<div class="sub_title">6.1	Building Information Models and Geospatial Information Systems (Heading 2 Example, Capitalise Each Word, Font: Times New Roman 12 Bold)</div>
				<p>In this article, various methods for integrating BIM and GIS will be investigated. There a number of different solutions to realize this integration. The integration challenges are also of prime importance, which needs to be considered in approaches used for BIM-GIS integration (paragraph example, font: justified, times new roman 12 typeface).</p>
				<div class="sub_title">6.1.1 6.1.1	Challenges in three-dimensional modelling (heading 3 example, only the first word capitalized, font: times new roman 12 Italic)</div>
			</div>
		</div>
	</section>
