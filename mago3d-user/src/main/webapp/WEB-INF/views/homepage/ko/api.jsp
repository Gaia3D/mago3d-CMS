...
<!--[if lt IE 9]>
	...
	<![endif]-->
<link rel="stylesheet" href="/externlib/${lang}/highlight/styles/dark.css" />
	...
	<div id="wrap">
		<div class="navigation">
			...
			<ul class="list">
				...
				<li class="item"><span class="api_title"> <a href="#changeBonudingBoxAPI">changeBonudingBoxAPI</a>
				</span></li>
