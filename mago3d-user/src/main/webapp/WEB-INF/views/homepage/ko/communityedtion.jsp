	...
	<section>
		<div class="contents">
			<div class="guide">
				<aside>
					<ul>
						<li><a href="/homepage/installguide.do">Install Guide</a>
						<li><a href="/homepage/communityedtion.do" class="on">Community Edition</a>
						<li><a href="#">Enterprise Edition</a>
					</ul>
				</aside>
				<div class="contents">
					<h3>Community Edtion Install Guide</h3>
					<div class="list">
						<ul>
					...
					<div class="sub_contents">
						...
						<p>만약 압축파일이 이름이  <b>mago3djs-develop</b>이면 <b>mago3djs</b>로 변경한 다음 아래 경로에 압축을 해제 합니다.</p>
						<div class="block">C:\git\repository\mago3djs</div>
					</div>
					<div class="sub_contents">
						<div id="NodeInstall"></div>
						<div class="title">Node Install</div>
						<p><a href="https://nodejs.org/ko/download/" style="display: inline;">node.js</a>홈페이지로 가서 
						설치하려는 윈도우 버전에 맞게 설치 파일을 받아 C:\nodejs 디렉토리에 설치합니다.</p>
						<div class="images">
							<img src="/images/${lang}/homepage/installguide/node.png" style="width: 410px;">
							<img src="/images/${lang}/homepage/installguide/node2.png" >
							<span class="dis">node.js 윈도우 버전 선택</span>
							<span class="dis" style="margin-left: 270px;">node.js 설치 시작</span>
						</div>
						 <div class="list">
					...
					<div class="sub_contents">
						...
						<div class="block"><a href="">F4D Converter 64bit (this installation requires Windows 7 or later)</a></div>
					</div>
				</div>
			</div>
		</div>
