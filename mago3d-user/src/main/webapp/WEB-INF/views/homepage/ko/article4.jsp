...
<head>
	...
	<title>가이아쓰리디의 mago3D가 FOSS4G Boston 2017에서 발표됩니다.| mago3D User</title>
	<!--[if lt IE 9]>
		...
		<div class="content">
			<div class="news-main">
				<div class="news-contents">
					<h3>가이아쓰리디의 mago3D가 FOSS4G Boston 2017에서 발표됩니다.</h3>
					<img src="/images/${lang}/homepage/boston.png" style="margin-left: 280px;">
					<p>안녕하세요?</p><br>
					<p>가이아쓰리디의 Live3D 플랫폼인 mago3D가 국제 FOSS4G(Free Open Source SW for Geospatial) Boston 2017 컨퍼런스에서 발표 주제로 선정되었습니다. 여느 해보다 경쟁이 치열했던 올해 심사를 통과해 발표의 기회를 얻게 된 점 깊은 영광으로 생각합니다. 가이아쓰리디는 FOSS4G Boston에서 초대용량 AEC(Architecture, Engineering, Construction), BIM, 3D GIS의 통합과 웹 환경에서 가시화를 소개할 예정입니다.</p>
					<br>
			...
			<div class="secondary-content" style="margin-top: -624px">
				<div class="con">
					<h3>문의하기</h3>
