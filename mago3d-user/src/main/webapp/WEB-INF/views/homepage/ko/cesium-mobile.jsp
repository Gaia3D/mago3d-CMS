...
<ul class="mobile-nav">
	...
	<div id="apiMenuContent" class="apiWrap">
		<div>
			...
			<ul class="apiLoca">
				...
				<li><label for="move_latitude">위도 </label> <input type="text" id="move_latitude" name="move_latitude" size="15" /></li>
				<li><label for="move_longitude">경도 </label> <input type="text" id="move_longitude" name="move_longitude" size="15" /></li>
				<li><label for="move_height">높이 </label> <input type="text" id="move_height" name="move_height" size="15" /></li>
				...
				<li><label for="move_roll">ROLL </label> <input type="text" id="move_roll" name="move_roll" size="15" />
					<button type="button" id="changeLocationAndRotationAPI" class="btn">변환</button></li>
			</ul>
		</div>
		<div>
			<h3>현재 위치 근처 Issue List(100개)</h3>
			<input type="radio" id="showNearGeoIssueList" name="nearGeoIssueList" value="true" onclick="changeNearGeoIssueList(true);" /> <label for="showNearGeoIssueList"> 표시 </label> <input type="radio" id="hideNearGeoIssueList" name="nearGeoIssueList" value="false" onclick="changeNearGeoIssueList(false);" /> <label for="hideNearGeoIssueList"> 비표시 </label>
		</div>
	</div>
	...
	<form:form id="issue" modelAttribute="issue" method="post" onsubmit="return false;">
		<div id="insertIssueMenuContent" class="insertIssueWrap">
			<table>
				<tr style="height: 35px;">
					<td style="width: 100px;" nowrap="nowrap"><form:label path="data_group_id">데이터 그룹</form:label> <span class="icon-glyph glyph-emark-dot color-warning"></span></td>
				...
				<tr style="height: 35px;">
					<td><form:label path="data_key">데이터명</form:label> <span class="icon-glyph glyph-emark-dot color-warning"></span></td>
				...
				<tr style="height: 35px;">
					<td><form:label path="latitude">위도</form:label> <span class="icon-glyph glyph-emark-dot color-warning"></span></td>
				...
				<tr style="height: 35px;">
					<td><form:label path="longitude">경도</form:label> <span class="icon-glyph glyph-emark-dot color-warning"></span></td>
				...
				<tr style="height: 60px;">
					<td><form:label path="title">제목</form:label> <span class="icon-glyph glyph-emark-dot color-warning"></span></td>
	...
	<div id="configMenuContent" class="configWrap">
		...
		<div>
			<h3>Bounding Box</h3>
			<input type="radio" id="showBoundingBox" name="boundingBox" value="true" onclick="changeBoundingBox(true);" /> <label for="showBoundingBox"> 표시 </label> <input type="radio" id="hideBoundingBox" name="boundingBox" value="false" onclick="changeBoundingBox(false);" /> <label for="hideBoundingBox"> 비표시 </label>
		</div>
		<div>
