			...
			<div id="main_content">
				<div class="input_box">
			        ...
			        <div>
						...
						<form:form id="userGroup" modelAttribute="userGroup" method="post" action="/user/updateUserGroup.do" onsubmit="return check();">
							<form:hidden path="user_group_id"/>
						<legend>Login Info</legend>
					  		<tr>
				  				<th width="25%">
				  					<form:label path="group_key">그룹 Key</form:label>
					 			</th>
					 			<td>
					  		...
					  		<tr>
					  			<th>
							  		<form:label path="name">그룹명</form:label>
					 			</th>
					 			<td>
					  		...
					  		<tr>
					  			<th>
							  		<form:label path="level">레벨</form:label>
					 			</th>
					 			<td>
									<form:select path="level" class="select_default">
					  		...
					  		<tr style="line-height: 40px;">
					  			<td colspan="2" style="text-align: center;">
					  				<input type="submit" value="수정" class="buttonPro purple" />
...
<script type="text/javascript">
	$(document).ready(function() {
		$("input:radio[name=use_yn]:input[value=${userGroup.use_yn}]").attr("checked", true);
	});
	function check() {
		if ($("#group_key").val() == "") {
		...
		if ($("#level").val() == "") {
			alert(JS_MESSAGE["user.group.level.empty"]);
			$("#level").focus();
			return false;
		}
	}
