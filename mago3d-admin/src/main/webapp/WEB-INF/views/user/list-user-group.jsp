											...
											<table class="inner-table scope-col">
												...
												<thead>
													<tr>
														...
														<th scope="col" class="col-toggle">OPT 상태</th>
												...
												<tbody id="user_list">
													<tr>
														<td colspan="7" class="col-none">등록된 사용자가 없습니다.</td>		
													</tr>
												</tbody>
											</table>
		...
		if (listUserGroupRole != null && listUserGroupRole.length > 0) {
			for(i=0; i<listUserGroupRole.length; i++ ) {
				...
				content += 	"<tr>"
						...
						+ 		"<td class=\"col-date-time\">" + userGroupRole.viewRegisterDate + "</td>"
						+ 	"</tr>";
			}
		} else {
			content += 	"<tr>"
			...
			for(i=0; i<userList.length; i++ ) {
				...
				userInfo = userList[i];
					content += 	"<tr>"
							...
							+ 		"<td class=\"col-toggle\">" + userInfo.viewOtpUseYn + "</td>"
							+ 		"<td class=\"col-toggle\">" + userInfo.viewStatus + "</td>"
							+ 		"<td  class=\"col-date-time\">" + userInfo.viewRegisterDate + "</td>"
							+ 	"</tr>";
			}
		} else {
			content += 	"<tr>"
