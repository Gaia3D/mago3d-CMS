...
<script>
	var getCoordinateRelativeToBuilding = function() {
		...
		var result = getCoordinateRelativeToBuildingAPI(MAGO3D_INSTANCE2, projectId, dataKey, new gaia3d.Point3D(parseFloat(inputPoint_x), parseFloat(inputPoint_y), parseFloat(inputPoint_z)), new gaia3d.Point3D());
