...
//			
//			configCacheController.reloadPolicyCache();
//		} catch(Exception e) {
//			e.printStackTrace();
//			result = "db.exception";
//		}
...
//	 * @return
//	 */
//	@RequestMapping(value = "ajax-update-policy-userotp.do", method = RequestMethod.POST)
//	@ResponseBody
//	public String ajaxUpdatePolicyUserOTP(HttpServletRequest request, Policy policy) {
//		JSONObject jSONObject = new JSONObject();
//		String result = "success";
//		try {
//			log.info("@@ policy = {} ", policy);
//			if(policy.getPolicy_id() == null || policy.getPolicy_id().intValue() <= 0
//					|| policy.getUser_otp_algorithm_type() == null || "".equals(policy.getUser_otp_algorithm_type())
//					|| policy.getUser_otp_number_length() == null || policy.getUser_otp_number_length() < 0
//					|| policy.getUser_otp_fail_count() == null || policy.getUser_otp_fail_count().intValue() < 0
//					|| policy.getUser_otp_app_modify_time() == null || policy.getUser_otp_app_modify_time().intValue() < 0
//					|| policy.getUser_otp_db_verify_time() == null || policy.getUser_otp_db_verify_time().intValue() < 0
////					|| policy.getUser_otp_allow_counter() == null || policy.getUser_otp_allow_counter().intValue() < 0
//					|| policy.getUser_otp_mobile_app_key_modify_yn() == null || "".equals(policy.getUser_otp_mobile_app_key_modify_yn())
//					|| policy.getUser_otp_pin_number_modify_yn() == null || "".equals(policy.getUser_otp_pin_number_modify_yn())) {
//				result = "policy.userotp.invalid";
//				jSONObject.put("result", result);
//				return jSONObject.toString();
//			}
//			
//			policyService.updatePolicyUserOTP(policy);
//			
//			configCacheController.reloadPolicyCache();
//		} catch(Exception e) {
//			e.printStackTrace();
...
//	 * @return
//	 */
//	@RequestMapping(value = "ajax-update-policy-system.do", method = RequestMethod.POST)
//	@ResponseBody
//	public String ajaxUpdatePolicySystem(HttpServletRequest request, Policy policy) {
//		JSONObject jSONObject = new JSONObject();
//		String result = "success";
//		try {
//			log.info("@@ policy = {} ", policy);
//			if(policy.getPolicy_id() == null || policy.getPolicy_id().intValue() <= 0
//					|| policy.getSystem_same_password_yn() == null || "".equals(policy.getSystem_same_password_yn())
//					|| policy.getSystem_account_down_check() == null || "".equals(policy.getSystem_account_down_check())
//					|| policy.getSystem_schedule_update_check() == null || "".equals(policy.getSystem_schedule_update_check())
//					|| policy.getSystem_connect_test_check() == null || "".equals(policy.getSystem_connect_test_check())
//					|| policy.getSystem_update_check() == null || "".equals(policy.getSystem_update_check())
//					|| policy.getSystem_delete_check() == null || "".equals(policy.getSystem_delete_check())
//					|| policy.getSystem_delete_type() == null || "".equals(policy.getSystem_delete_type())
//					) {
//				result = "policy.system.invalid";
//				jSONObject.put("result", result);
//				return jSONObject.toString();
//			}
//			
//			policyService.updatePolicySystem(policy);
//
//			configCacheController.reloadPolicyCache();
//		} catch(Exception e) {
//			e.printStackTrace();
...
//	 * @return
//	 */
//	@RequestMapping(value = "ajax-update-policy-account.do", method = RequestMethod.POST)
//	@ResponseBody
//	public String ajaxUpdatePolicyAccount(HttpServletRequest request, Policy policy) {
//		JSONObject jSONObject = new JSONObject();
//		String result = "success";
//		try {
//			log.info("@@ policy = {} ", policy);
//			if(policy.getPolicy_id() == null || policy.getPolicy_id().intValue() <= 0
//					|| policy.getAccount_password_view_check() == null || "".equals(policy.getAccount_password_view_check())
//					|| policy.getAccount_schedule_update_check() == null || "".equals(policy.getAccount_schedule_update_check())
//					|| policy.getAccount_update_check() == null || "".equals(policy.getAccount_update_check())
//					|| policy.getAccount_delete_check() == null || "".equals(policy.getAccount_delete_check())
//					|| policy.getAccount_delete_type() == null || "".equals(policy.getAccount_delete_type())
//					) {
//				result = "policy.account.invalid";
//				jSONObject.put("result", result);
//				return jSONObject.toString();
//			}
//			
//			policyService.updatePolicyAccount(policy);
//
//			configCacheController.reloadPolicyCache();
//		} catch(Exception e) {
//			e.printStackTrace();
...
//	 * @return
//	 */
//	@RequestMapping(value = "ajax-update-policy-approval.do", method = RequestMethod.POST)
//	@ResponseBody
//	public String ajaxUpdatePolicyApproval(HttpServletRequest request, Policy policy) {
//		JSONObject jSONObject = new JSONObject();
//		String result = "success";
//		try {
//			log.info("@@ policy = {} ", policy);
//			if(policy.getPolicy_id() == null || policy.getPolicy_id().intValue() <= 0
//					|| policy.getApproval_temp_password_type() == null || "".equals(policy.getApproval_temp_password_type())
//					|| policy.getApproval_sign_check() == null || "".equals(policy.getApproval_sign_check())
//					|| policy.getApproval_after_sign() == null || "".equals(policy.getApproval_after_sign())
//					|| policy.getApproval_auto_reject_yn() == null || "".equals(policy.getApproval_auto_reject_yn())
//					) {
//				result = "policy.approval.invalid";
//				jSONObject.put("result", result);
//				return jSONObject.toString();
//			}
//			
//			policyService.updatePolicyApproval(policy);
//
//			configCacheController.reloadPolicyCache();
//		} catch(Exception e) {
//			e.printStackTrace();
