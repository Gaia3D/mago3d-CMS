...
//		userInfo.setDelete_flag(UserInfo.STATUS_LOGICAL_DELETE);
	...
	public Map<String, Object> ajaxInsertUserInfo(HttpServletRequest request, UserInfo userInfo) {
		...
		try {
			...
			String encryptPassword = BCrypt.hashpw(userInfo.getPassword(), salt);
...
//			userInfo.setDelete_flag(UserInfo.STATUS_LOGICAL_DELETE);
	...
	private String getSearchParameters(UserInfo userInfo) {
		...
		buffer.append("&");
		buffer.append("search_word=" + StringUtil.getDefaultValue(userInfo.getSearch_word()));
		buffer.append("&");
		buffer.append("search_option=" + StringUtil.getDefaultValue(userInfo.getSearch_option()));
		buffer.append("&");
		try {
			buffer.append("search_value=" + URLEncoder.encode(StringUtil.getDefaultValue(userInfo.getSearch_value()), "UTF-8"));
		} catch(Exception e) {
			e.printStackTrace();
			buffer.append("search_value=");
		}
		buffer.append("&");
		buffer.append("user_group_id=" + userInfo.getUser_group_id());
		buffer.append("&");
		buffer.append("status=" + StringUtil.getDefaultValue(userInfo.getStatus()));
		buffer.append("&");
		buffer.append("user_insert_type=" + StringUtil.getDefaultValue(userInfo.getUser_insert_type()));
		buffer.append("&");
		buffer.append("start_date=" + StringUtil.getDefaultValue(userInfo.getStart_date()));
		buffer.append("&");
		buffer.append("end_date=" + StringUtil.getDefaultValue(userInfo.getEnd_date()));
		buffer.append("&");
		buffer.append("order_word=" + StringUtil.getDefaultValue(userInfo.getOrder_word()));
		buffer.append("&");
		buffer.append("order_value=" + StringUtil.getDefaultValue(userInfo.getOrder_value()));
		buffer.append("&");
		buffer.append("list_count=" + userInfo.getList_counter());
	...
	private String getListParameters(HttpServletRequest request) {
		...
		buffer.append("&");
		buffer.append("user_group_id=" + request.getParameter("user_group_id"));
		buffer.append("&");
		buffer.append("status=" + StringUtil.getDefaultValue(request.getParameter("status")));
		buffer.append("&");
		buffer.append("user_insert_type=" + StringUtil.getDefaultValue(request.getParameter("user_insert_type")));
		buffer.append("&");
