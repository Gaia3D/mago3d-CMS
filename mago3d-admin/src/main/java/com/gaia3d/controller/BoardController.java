...
public class BoardController {
	...
	private String getSearchParameters(Board board) {
		...
		buffer.append("&");
		buffer.append("search_word=" + StringUtil.getDefaultValue(board.getSearch_word()));
		buffer.append("&");
		buffer.append("search_option=" + StringUtil.getDefaultValue(board.getSearch_option()));
		buffer.append("&");
		try {
			buffer.append("search_value=" + URLEncoder.encode(StringUtil.getDefaultValue(board.getSearch_value()), "UTF-8"));
		} catch(Exception e) {
			e.printStackTrace();
			buffer.append("search_value=");
		}
		buffer.append("&");
		buffer.append("use_yn=" + StringUtil.getDefaultValue(board.getUse_yn()));
		buffer.append("&");
		buffer.append("start_date=" + StringUtil.getDefaultValue(board.getStart_date()));
		buffer.append("&");
		buffer.append("end_date=" + StringUtil.getDefaultValue(board.getEnd_date()));
		buffer.append("&");
		buffer.append("order_word=" + StringUtil.getDefaultValue(board.getOrder_word()));
		buffer.append("&");
		buffer.append("order_value=" + StringUtil.getDefaultValue(board.getOrder_value()));
