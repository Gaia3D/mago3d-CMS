...
create table policy(
	...
	content_menu_group_root					varchar(60)			default 'MENU ROOT',
	content_user_group_root					varchar(60)			default 'USER ROOT',
	content_layer_group_root				varchar(60)			default 'LAYER ROOT',
	content_data_group_root					varchar(60)			default 'DATA ROOT',
