...
public class URLHelper {
    ...
    // login 의 경우 통과
    public static final String[] EXCEPTION_URI = { 	"login", "call-api", "call-radius", "call-cache", "call-ha-status", "call-list-user-session", "call-icmp-duplication-check", 
    												"call-dbcp" };
    ...
    public static final String[] LOG_EXCEPTION_URI = { "ajax-loadbalancing-status", "list-access-log", "ajax-list-access-log" };
	// 엑셀 파일 처리 관련 URL
