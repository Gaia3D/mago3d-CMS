...
//	 * @return
//	 */
//	Long getServerGroupUserTotalCount(UserInfo userInfo);
//	
//	/**
//	 * server_group_id 그룹을 제외한 사용자 수
//	 * @param userInfo
//	 * @return
//	 */
//	Long getExceptServerGroupUserByGroupIdTotalCount(UserInfo userInfo);
//
//	/**
//	 * 사용자 목록
//	 * @param userInfo
...
//	 * @return
//	 */
//	List<UserInfo> getListServerGroupUser(UserInfo userInfo);
//	
//	/**
//	 * server_group_id를 제외한 사용자 목록
//	 * @param userInfo
//	 * @return
//	 */
//	List<UserInfo> getListExceptServerGroupUserByGroupId(UserInfo userInfo);
//	
//	/**
//	 * 사용자 아이디 중복 건수
//	 * @param user_id
...
//	 * @return
//	 */
//	UserInfo getServerGroupUserInfo(UserInfo userInfo);
//	
//	/**
//	 * 사용자 등록
//	 * @param userInfo
...
//	
//	/**
//	 * 서버 테이블의 사용자 그룹 정보 등록
//	 * @param userInfo
//	 * @return
//	 */
//	int insertServerGroupUser(UserInfo userInfo);
//	
//	/**
//	 * 사용자 수정
//	 * @param userInfo
...
//	
//	/**
//	 * 서버 테이블의 사용자 그룹 정보 변경
//	 * @param userInfo
//	 * @return
//	 */
//	int updateServerGroupUser(UserInfo userInfo);
//	
//	/**
//	 * 사용자 상태 수정
//	 * @param userInfo
...
//	 * @return
//	 */
//	int deleteServerGroupUser(UserInfo userInfo);
}
